...
import { AboutSection } from "@/components/georgian/about-section";

export const metadata: Metadata = {
  title: "О нас — Доставка «Вкусно как в Грузии»",
  description: "История нашего сервиса, команда, философия.",
};
            ...
            {[
              ...
              <div key={item.num} className="flex gap-6">
                ...
                <div>
                  ...
                  <p className="text-cream/45 body-mono leading-relaxed">{item.desc}</p>
                </div>
              </div>
            ))}
          </div>
