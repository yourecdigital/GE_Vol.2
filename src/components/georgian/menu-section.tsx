...
import { MenuDishCard } from "@/components/georgian/menu-dish-card";
...
function MenuCard({ item, index }: { item: MenuItem; index: number }) {
  ...
  return (
    ...
    >
      <motion.div initial={false} className="flex items-center justify-between mb-1">
        {item.badge ? (
      ...
      <p className="mt-2 text-ink/45 text-[13px] leading-relaxed body-mono flex-1">{item.shortDesc}</p>
